...
ДИҚҚАТ — ЭСКИРГАН. Бу скрипт эски parse_kml.ps1 қолдирган тирқишларни
ямаш учун ёзилган эди. Энди navoi_geo.js ни build_geo.py қуради ва у
тирқиш ҳам, устма-устлик ҳам ҚОЛДИРМАЙДИ. build_geo.py натижаси устидан
буни ишлатманг: полигонларни беҳуда қайта қирқиб, шаклни бузади.
